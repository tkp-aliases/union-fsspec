...
lint-py:  ## lint python with ruff
	python -m ruff check union_fsspec
	python -m ruff format --check union_fsspec
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix union_fsspec
	python -m ruff format union_fsspec
...
test:  ## run python tests
	python -m pytest -v union_fsspec/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v union_fsspec/tests --cov=union_fsspec --cov-report term-missing --cov-report xml
